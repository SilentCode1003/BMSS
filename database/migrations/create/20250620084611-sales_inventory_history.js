  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE sales_inventory_history (
        ...
        KEY sales_inventory_history_ibfk_2_idx (sih_productid),
        CONSTRAINT sales_inventory_history_ibfk_1 FOREIGN KEY (sih_detailid) REFERENCES sales_detail (st_detail_id),
        CONSTRAINT sales_inventory_history_ibfk_2 FOREIGN KEY (sih_productid) REFERENCES master_product (mp_productid)
