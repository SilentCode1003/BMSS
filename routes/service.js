...
router.put('/status', (req, res) => {
  try {
    ...
    let updateStatement = helper.UpdateStatement('services', 's', ['status'], ['id'])
...
router.put('/edit', (req, res) => {
  try {
    ...
    let updateStatement = helper.UpdateStatement('services', 's', columns, arguments)

    let checkStatement = helper.SelectStatement(`select * from services where s_name = ?`, [name])
