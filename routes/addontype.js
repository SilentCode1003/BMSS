...
router.post('/save', (req, res) => {
  try {
    ...
    let checkStatement = helper.SelectStatement(`select * from addon_type where at_name = ?`, [
      name,
    ])
...
router.put('/status', (req, res) => {
  try {
    ...
    let updateStatement = helper.UpdateStatement('addon_type', 'at', ['status'], ['id'])
...
router.put('/edit', (req, res) => {
  try {
    ...
    let updateStatement = helper.UpdateStatement('addon_type', 'at', columns, arguments)
